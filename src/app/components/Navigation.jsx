...
export default function Navigation({ navItems = [] }) {
  ...
  return (
    <>
      {/* Toggle Button */}
      <button
        className={`fixed top-[20px] right-[20px] z-50 cursor-pointer transition-right duration-150 ease-in max-md:block md:hidden ${
          navigationOpenState ? "max-md:right-[210px]" : "max-md:right-[40px]"
        }`}
      ...
      <nav
        className={`fixed top-0 right-0 flex justify-between items-center text-center z-50 bg-white shadow-md h-[70px] px-12 
              ...
              max-md:h-screen max-md:w-[200px] max-md:top-0 max-md:shadow-lg max-md:duration-300 ${
